# Generated by Django 5.0.14 on 2026-08-26 01:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['action', '-created_at'], name='audit_log_e_action_fec2e0_idx'), models.Index(fields=['object_type', 'object_id'], name='audit_log_e_object__848679_idx')],
            },
        ),
    ]
